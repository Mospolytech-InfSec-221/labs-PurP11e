#include "Game_Biboev(2).h"

Game_Biboev::Game_Biboev()
{
	this->year = 1;
	this->phase = 1;
}
...
Game_Biboev::Game_Biboev(int gamers_count)
{
	this->year = 1;
	this->phase = 1;
...
Game_Biboev::Game_Biboev(const Game_Biboev& c_game)
{
	// копирование игроков
...
void Game_Biboev::phase8()
{

}

void Game_Biboev::phase246()
{
	this->phase++;
...
void Game_Biboev::phase246_bones()
{
...
void Game_Biboev::phase246_advisor()
{
	int pass_count = 0;
...
bool Game_Biboev::load_game(std::string filename)
{
	return true;
}

bool Game_Biboev::save_game(std::string filename)
{
	return true;
}
